 ...
 */
class getRoomReservationRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\RoomReservationRepository' shared autowired service.
     *
     * @return \App\Repository\RoomReservationRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'RoomReservationRepository.php';

        return $container->privates['App\\Repository\\RoomReservationRepository'] = new \App\Repository\RoomReservationRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
