 ...
 */
class getBookLoanRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\BookLoanRepository' shared autowired service.
     *
     * @return \App\Repository\BookLoanRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'BookLoanRepository.php';

        return $container->privates['App\\Repository\\BookLoanRepository'] = new \App\Repository\BookLoanRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
