 ...
 */
class getBookReviewRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\BookReviewRepository' shared autowired service.
     *
     * @return \App\Repository\BookReviewRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'BookReviewRepository.php';

        return $container->privates['App\\Repository\\BookReviewRepository'] = new \App\Repository\BookReviewRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
