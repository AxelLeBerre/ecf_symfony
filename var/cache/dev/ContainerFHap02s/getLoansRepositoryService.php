 ...
 */
class getLoansRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\LoansRepository' shared autowired service.
     *
     * @return \App\Repository\LoansRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'LoansRepository.php';

        return $container->privates['App\\Repository\\LoansRepository'] = new \App\Repository\LoansRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
